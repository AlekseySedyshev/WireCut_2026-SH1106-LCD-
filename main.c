...
void init(void)
{
    ...
    { // Step driver pins configuration
        ...
        TIM1->PSC = (TIM_PRESC - SPEED_DEF * 100) - 1; // 25000     // Тут можно настроить скорость под себя
        TIM1->ATRLR = 2;
...
void ReadEEPROM(void)
{
    ...
    if (set.knife > KNIFE_MAX)
        set.knife = KNIFE_DEF_CUT;
    if (set.knife_open > KNIFE_MAX)
        set.knife_open = KNIFE_OPEN;
    if (set.knife_close > KNIFE_MAX)
...
void key_scan(void)
{
    if (!UP())
    {
        if (but_press >= SHORT_PRESS && but_press <= SEC5_PRESS && flag_key == true)
        {
            ...
            if (menu_x == 1 && menu_y == 5 && set.knife < KNIFE_MAX) // положение ножа при зачистке
            {
                set.knife += 1;
            }
            if (menu_x == 1 && menu_y == 7 && set.knife_open < KNIFE_MAX) // положение ножа открытого
            {
                set.knife_open += 1;
            }
            if (menu_x == 1 && menu_y == 6 && set.knife_close < KNIFE_MAX) // положение ножа закрытого
            {
                set.knife_close += 1;
            }
        ...
        if (but_press >= SEC5_PRESS && but_press < SEC10_PRESS && flag_key == true)
        {
            ...
            if (menu_x == 1 && menu_y == 5 && set.knife <= (KNIFE_MAX - 11)) // положение ножа при зачистке
            {
                set.knife += 10;
            }
            if (menu_x == 1 && menu_y == 7 && set.knife_open <= (KNIFE_MAX - 11)) // положение ножа открытого
            {
                set.knife_open += 10;
            }
            if (menu_x == 1 && menu_y == 6 && set.knife_close <= (KNIFE_MAX - 11)) // положение ножа закрытого
            {
                set.knife_close += 10;
            }
    ...
    if (!DOWN())
    {
        if (but_press >= SHORT_PRESS && but_press <= SEC5_PRESS && flag_key == true)
        {
            ...
            if (menu_x == 1 && menu_y == 7 && set.knife_open > 1)
            {
                set.knife_open -= 1;
            }
            if (menu_x == 1 && menu_y == 6 && set.knife_close > 1)
            {
                set.knife_close -= 1;
            }
        ...
        if (but_press > SEC5_PRESS && but_press < SEC10_PRESS && flag_key == true)
        {
            ...
            if (menu_x == 1 && menu_y == 7 && set.knife_open > 10)
            {
                set.knife_open -= 10;
            }
            if (menu_x == 1 && menu_y == 6 && set.knife_close > 10)
            {
                set.knife_close -= 10;
            }
...
{
    TIM1->CTLR1 &= (~TIM_CEN);
    TIM1->PSC = (TIM_PRESC - (motor_speed * 100)) - 1;
}
