...
#define SW_REVISION "1.10"
#define SW_DATE "11/04/2026"
...
#define WIRE_DEF_B 1296u // 185u // длина середины
#define WIRE_DEF_C 2u    // 10u  // длинна конца

#define KNIFE_DEF_CUT 35u // Обрезание провода

#define KNIFE_OPEN 65u  //
#define KNIFE_CLOSE 20u //
#define KNIFE_MAX 200u
